...
class CollectionResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            FileUpload::make('image_path')->image()->disk('public')->directory('collections')
                ->acceptedFileTypes(['image/jpeg','image/png','image/webp'])->maxSize(4096),
            Select::make('products')->relationship('products', 'name')->multiple()->preload()->searchable(),
            TextInput::make('position')->numeric()->default(0),
            Toggle::make('is_active')->default(true),
            Toggle::make('is_featured')->label('Show on the home page'),
        ])->columns(2);
    }
